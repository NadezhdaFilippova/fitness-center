...
/* harmony import */ var _modules_movie__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/movie */ "./js/modules/movie.js");
...
/* harmony import */ var _modules_tel_validate__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/tel-validate */ "./js/modules/tel-validate.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_movie__WEBPACK_IMPORTED_MODULE_2__["replaceMovie"])();
    Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["onOpenTabs"])();
    Object(_modules_tel_validate__WEBPACK_IMPORTED_MODULE_5__["onTelInput"])();
  });
});
...
/*!*****************************!*\
  !*** ./js/modules/movie.js ***!
  \*****************************/
/*! exports provided: replaceMovie */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "replaceMovie", function() { return replaceMovie; });
var movie = document.querySelector('.movie');
var link = movie.querySelector('.movie__link');
// const movieImage = movie.querySelector('.movie__back');
var playButton = movie.querySelector('.movie__button');
var id = '9TZXsZItgdw';
var generateUrl = function generateUrl(elem) {
  var query = '?autoplay=1&loop=1&&playlist=9TZXsZItgdw';
  return 'https://www.youtube.com/embed/' + elem + query;
};
var createIframe = function createIframe(elem) {
...
var setupMovie = function setupMovie() {
...
var replaceMovie = function replaceMovie() {
  if (movie) {
    setupMovie();
  }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vendor'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());

var trainers = document.querySelector('[data-trainers-swiper]');
var reviews = document.querySelector('[data-reviews-swiper]');
trainers.classList.remove('no-js');
var trainersSwiperParams = {
...
var initTrainersSwiper = function initTrainersSwiper() {
  return new !(function webpackMissingModule() { var e = new Error("Cannot find module 'vendor'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(trainers, trainersSwiperParams);
};
var slideDuplicates = document.querySelectorAll('.swiper-slide-duplicate');
slideDuplicates.forEach(function (item) {
  item.removeAttribute('tabindex');
});
initTrainersSwiper();
var initReviewsSwiper = function initReviewsSwiper() {
  return new !(function webpackMissingModule() { var e = new Error("Cannot find module 'vendor'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(reviews, {
    autoHeight: true,
    navigation: {
...
/*!****************************!*\
  !*** ./js/modules/tabs.js ***!
  \****************************/
/*! exports provided: onOpenTabs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onOpenTabs", function() { return onOpenTabs; });
var tabButtons = document.querySelectorAll('.membership__duration-button');
var tabContents = document.querySelectorAll('.membership__tab-content');
var onOpenTabs = function onOpenTabs() {
  if (tabButtons) {
    tabButtons.forEach(function (button) {
      button.addEventListener('click', function (e) {
        var btnTarget = e.currentTarget;
        var duration = btnTarget.dataset.duration;
        ...
        document.querySelector("#".concat(duration)).classList.add('is-active');
      });
    });
  }
};
